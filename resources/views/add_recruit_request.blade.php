...
<head>
    ...
    <title>Add Recruitment Request - {{ $siteTitle }}</title>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="view_recruit_request_default">View
                                            Recruitment</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Recruitment</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" id="requestForm" method="post" action="javascript:void(0)">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="rfh_no" class="form-control"
                                                            placeholder="RFH No" name="rfh_no" required />
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="no_of_position" class="form-control"
                                                            placeholder="No. of Position" name="no_of_position"
                                                            required />
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="critical_position" id="critical_position"
                                                            class="choices form-control" required>
    ...
    <!-- Common JS -->
    <script src="../assets/pro_js/add_recruit_request.js"></script>
    <script type="text/javascript">
    $(document).ready(function() {
        var page = "add_recruit_request";

        if (page == "add_recruit_request") {
            $(".recruit_req_m").addClass("active");
        }

    });

    var reqcruitment_request_process_link = "{{url('reqcruitment_request_process')}}";
