        ...
        <div id="main">
            ...
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Ticket Candidate Profile</h3>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="ticket_report">Ticket Report</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Ticket Candidate Profile</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- followup model start -->
                                            ...
                                            <button type="button" id="btnFollowup" class="btn btn-outline-warning" style="display:none;" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="followupModalTitle">Followup History - <span id="fh_candidate_name"></span></h5>
                    ...
                    <div class="card">
                        <div class="card-header">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 info_tool">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <span class="badge bg-secondary" title="Follow Up"><i class="bi bi-stack"></i> Follow Up</span>
                                            <span class="badge bg-light-danger" title="Red Flag Status"><i class="bi bi-flag-fill"></i> Red Flag Status</span>
                                            <span class="badge bg-light-warning" title="Offer Rejected"><i class="bi bi-x-circle-fill"></i> Offer Rejected</span>
                            ...
                            <div class="row mt-4 filter_tool" id="show_filter_div" style="display:none;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="Created By">Recruiter</label>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.full.js'></script>
    ...
    <script src="../assets/pro_js/ticket_profiles_recruiter.js"></script>
		...
		<script type="text/javascript">
            ...
            var get_candidate_profile_link = "{{url('get_ticket_candidate_details')}}";
