...
<body>
                                ...
                                <input type="hidden" name="fn_status" value ="2" id="fn_status">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label for="Remark">Proforma Invoice: </label>
                                                <input type="file" name="fn_attach" id="fn_attach" class="form-control">
                                            </div>
                                        </div>
                                        <hr>
    ...
    <!-- Common JS -->
    <script src="../assets/pro_js/finance/offers_finance.js"></script>


    <script type="text/javascript">
    $(document).ready(function() {
        var page = "offers_finance";

        if (page == "offers_finance") {
            $(".offers_finance_m").addClass("active");
        }
    ...
    var get_pending_po_request_link = "{{url('get_pending_po_request')}}";
    var process_fn_approval_link = "{{url('process_fn_postatus')}}";
    var get_approved_po_fin_link = "{{url('get_approved_po_fin')}}";
