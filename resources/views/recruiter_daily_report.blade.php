...
<body>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="open_position" role="tabpanel"
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped" id="r_daily_report_tb" cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                            <th>S.No.</th>
                                                            <th>Recruiter</th>
                                                            <th>Position Working</th>
                                                            <th>RFH NO</th>
                                                            <th>CV per position</th>
                                                            <th>Total Cvs</th>
                                                            <th>RFH No. for Offers Released </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
    ...
    $(document).ready(function() {
        ...
        var page = "recruiter_daily_report";

        if (page == "recruiter_daily_report") {
            $(".recruiter_daily_report_m").addClass("active");
        }
