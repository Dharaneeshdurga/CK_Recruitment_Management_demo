...
<head>
    ...
    <title>Recruiter Report - {{ $siteTitle }}</title>
...
<body>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row mt-4 filter_tool" id="show_filter_div">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="af_critical_position">Critical Position</label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="af_position_status">Position Status</label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="af_assigned_status">Assigned Status</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="af_billing_status">Billing Status</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="af_function">Function</label>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="af_recruiters">Recruiters</label>
                                        <select name="af_recruiters" id="af_recruiters" class="form-control js-select2">
                            ...
                            <table class="table" id="table1" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="pro_ageing">Profile Ageing</th> -->
                                        <th>CV Count</th>
    ...
    <script src="../assets/pro_js/recruiter_report.js"></script>
    ...
    var get_ticket_report_link = "{{url('get_recruiter_report')}}";
    ...
    var get_recruiter_team_list_link = "{{url('get_recruiter_team_list_af')}}";
    ...
    var get_stagesof_recruitment_rr_link = "{{url('get_stagesof_recruitment_rr')}}";
