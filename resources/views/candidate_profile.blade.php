...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <!-- ctc edit popup start-->
                <button type="button" class="btn btn-outline-warning" id="show_ctcedit_pop" data-bs-backdrop="true"
                    style="display:none" data-bs-toggle="modal" data-bs-target="#edit_ctcpop_modal_div">Edit NOP
                    Modal</button>

                <div class="modal fade text-left" id="edit_ctcpop_modal_div" tabindex="-1" role="dialog"
                    aria-labelledby="show_edit_ctcpop_title" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="show_edit_ctcpop_title"></h4>
                                <button type="button" id="close_edit_ctcpop" class="close" data-bs-dismiss="modal"
                                    aria-label="Close">
                                    <i data-feather="x"></i>
                                </button>
                            </div>
                            ...
                            <div class="modal-body">
                                ...
                                <label>Closed Salary</label>
                                <input type="text" class="form-control" id="current_closed_salary"
                                    name="current_closed_salary" value="">
                                
                                <input type="hidden" class="form-control" id="rfh_ctc" name="rfh_ctc" value="">
                                <input type="hidden" class="form-control" id="cid_ctc" name="cid_ctc" value="">

                                <span id="ctc_error" style="color:red;display:none;">* fields are required</span>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btnEditCtcUpdate" class="btn btn-primary ml-1 btn-sm"
                                    data-bs-dismiss="modal">
                                    <i class="bx bx-check d-block d-sm-none"></i>
                                    <span class="d-sm-block d-none" id="updateCtcbtn">Update</span>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                            ...
                            <div class="row mt-4 filter_tool" id="show_filter_div" style="display:none;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="af_position_status" id="af_position_status"
                                            class="form-control js-select2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="af_created_by" id="af_created_by" class="form-control js-select2">
                        ...
                        <!-- candidate delete popup start-->
                        <button type="button" class="btn btn-outline-warning" id="confirmbox" data-bs-backdrop="true"
                            style="display:none" data-bs-toggle="modal" data-bs-target="#delete_pop_modal_div">Delete
                            Pop Modal</button>
                        ...
                        <!-- candidate delete popup end-->

                        <!-- candidate edit popup start-->
                        <button type="button" class="btn btn-outline-warning" id="confirmEditbox" data-bs-backdrop="true"
                            style="display:none" data-bs-toggle="modal" data-bs-target="#edit_pop_modal_div">Delete
                            Pop Modal</button>
                        ...
                        <div class="modal fade text-left" id="edit_pop_modal_div" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="show_edit_pop_title">Edit Candidate Details</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="candidate_name" name="candidate_name" class="form-control" placeholder="Candidate Name" required="">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="candidate_gender" id="candidate_gender" class="form-control" required="">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="candidate_email" name="candidate_name" class="form-control" placeholder="Candidate Email" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="candidate_source">Candidate Source </label>
                                                    <input type="text" name="candidate_source" id="candidate_source" list="get_candidate_source" class="form-control" placeholder="Candidate Source" required="">
                                                    <datalist id="get_candidate_source" placeholder="Choose Remark">
    ...
    <script src="../assets/pro_js/view_profiles_list.js"></script>
    ...
    $(document).ready(function() {
        ...
        var page = "view_candidate_profile";

        if (page == "view_candidate_profile") {
            $(".candidate_profile_m").addClass("active");
        }
    ...
    var get_candidate_profile_link = "{{url('get_candidate_profile_report')}}";
    ...
    var process_candidate_delete_link = "{{url('process_candidate_delete')}}";
    var get_candidate_details_ed_link = "{{url('get_candidate_details_ed')}}";
    var process_candidate_edit_link = "{{url('process_candidate_edit')}}";

    var update_closed_salary_bc_link = "{{url('update_closed_salary_bc')}}";
