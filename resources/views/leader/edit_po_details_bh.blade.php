...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                <button type="button" onclick="add_component_extra();" class="btn btn-sm btn-primary">Edit Component</button>

                                    <form class="form" id="addpoForm" action="javascript:void(0)">
    ...
    <!-- Common JS -->
    <script src="../assets/pro_js/leader/edit_po_component.js"></script>
    ...
    var get_po_components_link = "{{url('get_po_components_bh')}}";
    var submit_po_process_link = "{{url('submit_po_process_bh')}}";
    var submit_OAT_process_link = "{{url('submit_oat_process_bh')}}";
    var submit_finance = "{{url('send_po_finance_l')}}";
    var submit_oat = "{{url('send_oat_mail')}}";
    </script>
</body>
