...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">List Candidate Profile</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                        <div class="modal-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="candidate_gender" id="candidate_gender" class="form-control"
                                                required="">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="candidate_email" name="candidate_name"
                                                class="form-control" placeholder="Candidate Email" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="candidate_source">Candidate Source </label>
                                            <input type="text" name="candidate_source" id="candidate_source"
                                                list="get_candidate_source" class="form-control"
                                                placeholder="Candidate Source" required="">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-info" id="editSubmit">Update</button>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 info_tool">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <span class="badge bg-info" title="CV"><i class="fa fa-eye"></i> CV</span>
                                            ...
                                            <span class="badge bg-light-danger" title="Red Flag Status"><i
                                                    class="fa fa-flag"></i> Red Flag Status</span>
    ...
    <!-- Common JS -->
    <script src="../assets/pro_js/list_profile.js"></script>
    ...
    var get_candidate_profile_link = "{{url('get_candidate_profile_list_report')}}";
    ...
    var process_candidate_delete_link = "{{url('process_candidate_delete_rl')}}";

    var get_candidate_details_ed_link = "{{url('get_candidate_details_ed_rl')}}";
    var process_candidate_edit_link = "{{url('process_candidate_edit_rl')}}";
