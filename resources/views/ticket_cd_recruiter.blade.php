...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="ticket_report_recruiter">Ticket Report</a></li>
    ...
    <script src="../assets/pro_js/ticket_profiles.js"></script>


    <script type="text/javascript">
    $(document).ready(function() {
        var page = "ticket_cd_recruiter";

        if (page == "ticket_cd_recruiter") {
    ...
    var get_candidate_profile_link = "{{url('get_ticket_cd_recruiter')}}";
