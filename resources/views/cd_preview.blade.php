...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <a class="nav-link" id="v-pills-action-tab" data-bs-toggle="pill"
                                            href="#v-pills-action" role="tab" aria-controls="v-pills-action"
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="v-pills-action" role="tabpanel"
                                                aria-labelledby="v-pills-action-tab">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="">Status</label>
                                                            <select class="form-control" name="candidate_doc_status" id="candidate_doc_status" >
                                                                <option value="">Choose</option>
                                                                <option value="Verified">Verified</option>
                                                                <option value="Not Verified">Not Verified</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group" id="c_doc_remark_div" style="display:none;">
                                                            <label for="">Remark</label>
                                                            <textarea name="c_doc_remark" id="c_doc_remark" class="form-control"></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <button class="btn btn-sm btn-primary" type="button" id="statusUpdatebtn">Update</button>
                                                        </div>
                                                    </div>
    ...
    <!-- Common JS -->
    <script src="../assets/pro_js/cd_preview.js"></script>
    ...
    var get_candidate_preview_details_link = "{{url('get_candidate_preview_details')}}";
