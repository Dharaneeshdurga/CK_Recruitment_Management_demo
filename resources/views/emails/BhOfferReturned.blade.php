...
<html>
<head>
    <title>CAREERS@HEPL: OFFER RETURNED</title>
</head>
<style>
    span{
        margin:-9px auto;
...
<body>
    ...
    <p>The CAREER OFFER for Candidate : <strong>Mr/Ms {{$details['candidate_name']}}</strong> For Position of : <strong>{{$details['candidate_position']}}</strong> with respect to RFH No: <strong>{{$details['rfh_no']}}</strong> IS RETURNED FOR WANT OF CORRECTIONS.</p>
    <br>
    <p>Please refer to remarks and submit the revised offer for approval. </p>
    <br><br>
