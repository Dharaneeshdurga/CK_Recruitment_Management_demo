...
<html>
<head>
    <title>CAREERS@HEPL:  OFFER APPROVED </title>
</head>
<style>
    span{
        margin:-9px auto;
...
<body>
    ...
    <p>The CAREER OFFER for Candidate : <strong>Mr/Ms {{$details['candidate_name']}}</strong> For Position of : <strong>{{$details['candidate_position']}}</strong> with respect to RFH No: <strong>{{$details['rfh_no']}}</strong> IS APPROVED.</p>
    <br>
    <p>Please proceed with release of offer to the candidate.</p>
    <br><br>
