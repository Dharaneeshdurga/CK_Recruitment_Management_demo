...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                   <li class="breadcrumb-item active" aria-current="page"> <a href="document_collection_bc">Document Collection</a></li>
                                    <li class="breadcrumb-item" aria-current="page">Candidate Profile</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <!-- Common JS -->
    <script src="../assets/pro_js/cd_preview_bc.js"></script>
    ...
    var get_candidate_preview_details_link = "{{url('get_candidate_preview_details_bc')}}";
