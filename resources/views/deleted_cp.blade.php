...
<head>
    ...
    <title>Deleted Ticket Candidate Profile - {{ $siteTitle }}</title>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="deleted_request">Deleted Request</a></li>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="af_position_status" id="af_position_status"
                                            ...
                                            <option value="Fresh Profile Submitted">Fresh Profile Submitted</option>
                                            <option value="Profiles Shortlist On-going">Profiles Shortlist On-going
                                            </option>
                                            <option value="Profiles shared for Screening with Interviewing Manager">
                                                Profiles shared for Screening with Interviewing Manager</option>
                                            <option value="Interview Ongoing">Interview Ongoing</option>
                                            <option value="CTC Negotiation on">CTC Negotiation on</option>
    ...
    <script src="../assets/pro_js/deleted_cp.js"></script>
    ...
    var get_del_candidate_profile_link = "{{url('get_del_candidate_profile')}}";
