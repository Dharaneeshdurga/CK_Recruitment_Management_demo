...
function get_offer_release_pop(cdID,name,rfh_no,hepl_recruitment_ref_number,recruiter){
            ...
            success: function (response) {
             ...
             //   var host = window.location.origin;
               ...
               // var host_url = host+"/"+response;
                ...
                send_to_budgie_ctc(or_cdID,response.filename);
...
function send_to_budgie_ctc(or_cdID,filename){
    $.ajax({
       // url: "http://127.0.0.1:8080/api/update_can_status",
        url: "http://216.48.177.166/budgie/public/index.php/api/update_can_status",
        type: "POST",
        cors: true ,
        data:{'can_id':or_cdID,'filename':filename},
        dataType: "json",
        success: function (data) {
...
function get_department_list(){
    $.ajax({
       ...
       url:"http://127.0.0.1:8080/api/get_departments",
        data: { },
        success: function (data) {
            if(data.length != 0){
                var html = '<option value="">Select</option>';
