...
//print_r($user_row);
           ...
           //->cc([$cc1,$cc2])
            ...
            //  $doc_upload_link =  "http://hub1.cavinkare.in/BUDGIE/public/index.php";
            ...
            return Datatables::of($get_candidate_profile_result)
                ...
                ->addColumn('action',function($row){
                    ...
                    if($row->c_doc_status =='Verified' && $row->payroll_status == 0 || $row->payroll_status == 4){
                        $or_btn = '<span class="badge bg-info" title="Offer Release Action" type="button" onclick="get_offer_release_pop('."'".$row->cdID."'".','."'".$row->candidate_name."'".','."'".$row->rfh_no."'".','."'".$row->hepl_recruitment_ref_number."'".','."'".$row->created_by."'".')"><i class="fa fa-file"></i></span>';
                    }
                    else{
                        $or_btn ='';
                    }
    ...
    public function send_to_payroll(Request $req){
     //  $att_file = $req->input('proof_attach');
       // exit;
        ...
        // $to_email = 'hrpayroll1@hemas.in900093'900';
