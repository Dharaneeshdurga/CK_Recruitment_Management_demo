...
class FinanceController extends Controller
{
    ...
    public function offers_finance(Request $request){
        ...
        if ($request->ajax()) {
            ...
            $created_by = $session_user_details->empID;
                ...
                $get_candidate_profile_result = $this->fnrepo->get_pending_po_request( $input_details );
            ...
            return Datatables::of($get_candidate_profile_result)
                ...
                ->addColumn('po_action',function($row){
                    ...
                    if($row->po_finance_status ==0 || $row->po_finance_status ==3){
                                ...
                                $btn = '<span class="badge bg-dark"><i class="bi bi-pencil" onclick="view_po_pop_fn('."'".$row->rfh_no."'".','."'".$row->cdID."'".','."'".$row->approver."'".');"></i></span>';
        ...
        return view('finance/offers_finance');
    ...
    public function get_approved_po_fin(Request $request){
        if ($request->ajax()) {
            ...
            $created_by = $session_user_details->empID;
                ...
                $get_candidate_profile_result = $this->fnrepo->get_approved_offers( $input_details );
