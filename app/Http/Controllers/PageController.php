...
class PageController extends Controller
{
    ...
    public function get_sub_position_title_af(){
        ...
        $get_sub_position_title_af_result = $this->corepo->get_sub_position_title_af(  );

        return $get_sub_position_title_af_result;
    }
    ...
    public function get_division_af(){
        $get_division_af_result = $this->corepo->get_division_af(  );

        return $get_division_af_result;
    }

    public function get_raisedby_af(){
        $get_raisedby_af_result = $this->corepo->get_raisedby_af(  );

        return $get_raisedby_af_result;
    }

    public function get_approvedby_af(){
        $get_approvedby_af_result = $this->corepo->get_approvedby_af(  );

        return $get_approvedby_af_result;
    }

    public function get_source_list_af(){
        $get_source_list_af_result = $this->corepo->get_source_list_af(  );

        return $get_source_list_af_result;
    }

    public function get_interviewer_af(){
        $get_interviewer_af_result = $this->corepo->get_interviewer_af(  );

        return $get_interviewer_af_result;
    }
