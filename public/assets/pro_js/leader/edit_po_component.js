            ...
            if(data.po_details_result.length !=0){
                ...
                for (let index = 0; index < po_details_result.length; index++) {
                    ...
                    if(po_details_result[index] =='Type of Engagement'){
                        ...
                        if(sno ==17){
                            html +='<tr id="add_comp_belows">';
                            alert(po_details_result[index]);
...
//alert("test");
    var html ='';
        html +='<tr id="add_comp_below">';
                    ...
                    html +='<td><div class="input-group"><span class="input-group-text">₹</span><input type="text" name="po_amount_month[]" value="" class="form-control p_month" onkeypress="num_validate(event)"></td></div>';
                    html +='<td><input type="text" style="display:block"  placeholder ="Enter Your Remark" name="remark[]"  class="form-control""></td></div>';

                    html +='</tr>';

$('#add_comp_below').before(html);
