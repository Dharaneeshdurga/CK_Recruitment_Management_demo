...
$(document).ready(function() {
    get_pending_nonpo_bc_list();
   // get_offer_list_bc_apo();
...
$("#pending_qc-tab").on('click', function() {
    get_pending_nonpo_bc_list();
});
$("#approved_qc-tab").on('click', function() {
    get_approved_non_po_list();
});
...
$("#offers_accepted-tab").on('click', function() {
    get_offer_accepted_for_bc();
});

$("#offers_rejected-tab").on('click', function() {
    get_offer_rejected_for_bc();
});
...
function get_pending_nonpo_bc_list(){
    table_cot_1 = $('#pending_nonpo_tb').DataTable({
        ...
        aoColumnDefs: [
            { 'visible': false, 'targets': [3,6,9,7,13] }
        ],
        ajax: {
            url: get_nonpo_pending_list_link,
            type: 'POST',
            data: function (d) {
        ...
        createdRow: function( row, data, dataIndex ) {
            ...
            $( row ).find('td:eq(16)').attr('data-label', 'Revert');
            $( row ).find('td:eq(17)').attr('data-label', 'Action for Approval');
...
function get_offer_list_bc_apo(){
    table_cot_1 = $('#offers_ra_tb').DataTable({
        ...
        aoColumnDefs: [
            { 'visible': false, 'targets': [3,6,9,12,13] }
        ],
        ajax: {
            url: get_offer_list_bc_apo_link,
            type: 'POST',
            data: function (d) {
                // d.af_from_date = $('#af_from_date').val();
        ...
        createdRow: function( row, data, dataIndex ) {
            ...
            $( row ).find('td:eq(13)').attr('data-label', 'BH Status');
            $( row ).find('td:eq(13)').attr('data-label', 'OAT Ageing');
            $( row ).find('td:eq(14)').attr('data-label', 'Offer Release');
...
function get_offer_accepted_for_bc(){
    table_cot_2 = $('#ap_offers_tb').DataTable({
        ...
        ajax: {
            url: get_offer_accepted_for_bc_link,
            type: 'POST',
            data: function (d) {
                // d.af_from_date = $('#af_from_date').val();
...
function get_offer_rejected_for_bc(){
    table_cot_2 = $('#re_offers_tb').DataTable({
        ...
        ajax: {
            url: get_offer_rejected_for_bc_link,
            type: 'POST',
            data: function (d) {
                // d.af_from_date = $('#af_from_date').val();
...
function get_approved_non_po_list(){
    table_cot_3 = $('#app_npo_tb').DataTable({
