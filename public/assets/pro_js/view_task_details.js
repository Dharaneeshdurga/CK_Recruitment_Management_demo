...
//alert(budgie_link);
    ...
    $.ajax({
        ...
        data: {
            ...
            "offer_accep_date":offer_accep_date,
            "history_rfh_no":history_rfh_no,
            "action_for_the_day":action_for_the_day,
            "cdID":cdID,
            "hepl_recruitment_ref_number":hepl_recruitment_ref_number,
            "budgie_link":budgie_link,
        },
        success: function (data) {
            ...
            if(data.response =='Updated'){
                ...
                console.log(data.can_name);
                call_budgieApiInsert(data.candidate_id,candidate_type,get_candidate_email,data.candidate_source,data.recruiter_name,data.recruiter_id,data.can_name,data.password);
...
function call_budgieApiInsert(candidate_id,candidate_type,can_email,can_source,r_name,r_id,can_name,password){

    $.ajax({
        url:  budgie_link + "api/insert_candidate_prohire",
