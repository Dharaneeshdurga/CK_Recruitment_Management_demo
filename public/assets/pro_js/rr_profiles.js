...
function get_profile_list(){
    ...
    var hr_refno = url.searchParams.get("hr_refno");

    var rec_id = url.searchParams.get("rec_id");
    ...
    table_cot = $('#c_profile').DataTable({
        ...
        createdRow: function( row, data, dataIndex ) {
            ...
            $( row ).find('td:eq(9)').attr('data-label', 'Recruiter');
            $( row ).find('td:eq(10)').attr('data-label', 'Created On');
        ...
        columns: [
            ...
            {   data: 'sub_position_title', name: 'rr.sub_position_title'  },
...
$("#af_from_date,#af_to_date,#af_position_status")
.on('change', function() {
